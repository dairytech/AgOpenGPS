...
namespace AgOpenGPS {
  public class CYouTurn {
    ...
    public void clearYoutTurnRelais( int relais ) {
      relayState &= (UInt32)( ~( 1 << ( relais ) ) );
    }
    public void setYoutTurnRelais( int relais ) {
      relayState |= (UInt32)( 1 << ( relais ) );
    }
    public void toggleYoutTurnRelais( int relais ) {
      relayState ^= (UInt32)( 1 << ( relais ) );
    }
    public void clearAllYoutTurnRelais() {
      relayState = 0;
    }
    public UInt32 getRelaisState() {
      return relayState;
    }
    public bool getRelaisStateOf( int relais ) {
      return ( relayState & ( 1 << relais ) ) != 0;
    }
