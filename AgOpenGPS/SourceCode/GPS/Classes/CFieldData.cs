...
namespace AgOpenGPS {
  public class CFieldData {
    ...
    public string AreaBoundaryLessInnersHectares {
      get {
        return ( areaBoundaryOuterLessInner * glm.m2ha ).ToString( "N2" ) + " Ha";
      }
    }

    public string AreaBoundaryLessInnersAcres {
      get {
        return ( areaBoundaryOuterLessInner * glm.m2ac ).ToString( "N2" ) + " Ac";
      }
    }

    //USer tally string
    public string WorkedUserHectares {
      get {
        return ( workedAreaTotalUser * glm.m2ha ).ToString( "N2" ) + " Ha";
      }
    }

    public string WorkedUserHectares2 {
      get {
        return ( workedAreaTotalUser * glm.m2ha ).ToString( "N2" );
      }
    }

    //user tally string
    public string WorkedUserAcres {
      get {
        return ( workedAreaTotalUser * glm.m2ac ).ToString( "N2" ) + " Ac";
      }
    }

    public string WorkedUserAcres2 {
      get {
        return ( workedAreaTotalUser * glm.m2ac ).ToString( "N2" );
      }
    }
    ...
    public string DistanceUserMeters {
      get {
        return Convert.ToString( (UInt16)( distanceUser ) ) + " m";
      }
    }

    public string DistanceUserFeet {
      get {
        return Convert.ToString( (UInt16)( distanceUser * glm.m2ft ) ) + " ft";
      }
    }

    //remaining area to be worked
    public string WorkedAreaRemainHectares {
      get {
        return ( ( areaBoundaryOuterLessInner - workedAreaTotal ) * glm.m2ha ).ToString( "N2" ) + " Ha";
      }
    }

    public string WorkedAreaRemainAcres {
      get {
        return ( ( areaBoundaryOuterLessInner - workedAreaTotal ) * glm.m2ac ).ToString( "N2" ) + " Ac";
      }
    }
    ...
    public string WorkRateHectares {
      get {
        return ( mf.vehicle.toolWidth * mf.pn.speed * 0.1 ).ToString( "N1" ) + "\r\nHa/hr";
      }
    }
    public string WorkRateAcres {
      get {
        return ( mf.vehicle.toolWidth * mf.pn.speed * 0.2471 ).ToString( "N1" ) + "\r\nAc/hr";
      }
    }
